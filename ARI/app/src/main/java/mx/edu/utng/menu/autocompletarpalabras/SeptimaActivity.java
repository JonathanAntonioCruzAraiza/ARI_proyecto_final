...
public class SeptimaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_septima_primo);

        //Casteo los elementos a utilizar.
        final Spinner spinner= (Spinner) findViewById(R.id.spinner7);
        btRevisar = (Button)findViewById(R.id.bt_revisar_primo);
        ...
        btRevisar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String strPlanet=Spinner7.getSelectedItem().toString();
                ...
                if (strPlanet.equals("I")){
                    startActivity(new Intent(SeptimaActivity.this,OptabaActivity.class));
