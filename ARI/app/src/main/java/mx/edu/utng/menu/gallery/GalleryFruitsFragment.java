...
public class GalleryFruitsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater,
        ...
        return inflater.inflate(R.layout.main_fragment_fruits,container,false) ;
    ...
    public static class FragmentImage extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater,
                                 @Nullable ViewGroup container,
                                 @Nullable Bundle savedInstanceState) {
           View rootView = inflater.inflate(R.layout.gallery_layout_fruits,container,false);
