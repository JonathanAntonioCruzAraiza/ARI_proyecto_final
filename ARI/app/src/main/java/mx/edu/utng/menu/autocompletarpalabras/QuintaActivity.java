...
public class QuintaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_quinta_familia);

        //Casteo los elementos a utilizar.
        final Spinner spinner= (Spinner) findViewById(R.id.spinner5);
        btRevisar = (Button)findViewById(R.id.bt_revisar_familia);
        ...
        btRevisar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String strPlanet=Spinner5.getSelectedItem().toString();
                ...
                if (strPlanet.equals("I")){
                    startActivity(new Intent(QuintaActivity.this,SextaActivity.class));
