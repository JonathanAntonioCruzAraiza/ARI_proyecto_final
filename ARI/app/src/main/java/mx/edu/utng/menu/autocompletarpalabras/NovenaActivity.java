...
public class NovenaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_novena_abuelo);

        //Casteo los elementos a utilizar.
        final Spinner spinner= (Spinner) findViewById(R.id.spinner9);
        btRevisar = (Button)findViewById(R.id.bt_revisar_abuelo);
        ...
        btRevisar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String strPlanet=Spinner9.getSelectedItem().toString();
                ...
                if (strPlanet.equals("U")){
                    startActivity(new Intent(NovenaActivity.this,DecimoActivity.class));
