...
public class SextaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sexta_amor);

        //Casteo los elementos a utilizar.
        final Spinner spinner= (Spinner) findViewById(R.id.spinner6);
        btRevisar = (Button)findViewById(R.id.bt_revisar_amor);
        ...
        btRevisar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String strPlanet=Spinner6.getSelectedItem().toString();
                ...
                if (strPlanet.equals("O")){
                    startActivity(new Intent(SextaActivity.this,SeptimaActivity.class));
